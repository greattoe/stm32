...
서보1은 TIM4의 CHANNEL2에, 서보2는 TIM3의 CHANNEL1에 연결하자.





**1.1 RCC 설정** 내부클럭 64(MHz)를 사용하도록 설정
 ...
 **1.2 TIM4 설정** TIM4 PWM 출력 채널 2번(PB7)으로 50(ms)주기의 PWM이 출력되도록 설정
  ...
  **1.3 TIM2 설정** TIM2 PWM 출력 채널 2번(PB7)으로 50(ms)주기의 PWM이 출력되도록 설정
